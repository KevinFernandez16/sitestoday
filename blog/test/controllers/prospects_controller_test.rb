...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { city: @prospect.city, firstname: @prospect.firstname, lastname: @prospect.lastname, phone: @prospect.phone, state: @prospect.state, streetaddress: @prospect.streetaddress, zip: @prospect.zip } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { city: @prospect.city, firstname: @prospect.firstname, lastname: @prospect.lastname, phone: @prospect.phone, state: @prospect.state, streetaddress: @prospect.streetaddress, zip: @prospect.zip } }
